...
return [
    ...
    'db' => [
        ...
        'connection' => [
            'default' => [
                'host' => 'mysql',
                'dbname' => 'testing_magento_local_development',
                'username' => 'testing_magento_local_develop',
                'password' => 'testing_magento_local_develop',
                'model' => 'mysql4',
                'engine' => 'innodb',
    ...
    'system' => [
        'default' => [
            ...
            'web' => [
                'unsecure' => [
                    'base_url' => 'https://testing-magento-development.local/',
                    'base_link_url' => '{{unsecure_base_url}}',
                    'base_static_url' => 'https://testing-magento-development.local/static/',
                    'base_media_url' => 'https://testing-magento-development.local/media/'
                ],
                'secure' => [
                    'base_url' => 'https://testing-magento-development.local/',
